...
#toast {
	...
	font-size: 18px;
	visibility: hidden;
	box-shadow: 0px 0px 100px #8fc0cf;
}
...
<h4 class="text-center bg-light p-3"> New Books </h4>
 <div class="container">
			...
			<div class="col-md-3">
				<div class="card crd-ho mt-2">
				  <div class="card-body text-center">
				     ...
				     <a href="view_details.jsp?bid=<%=b.getId()%>" class="btn btn-success btn-sm ml-1">Details
