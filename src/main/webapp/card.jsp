	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 ">
				<div class="card bg-white">
					<div class="card-body p-2">
						<h4 class="text-center bg-primary p-2">Your Selected Item</h4>
			...
			<div class="col-md-6">
				<div class="card bg-white">
					<div class="card-body p-2">
						<h4 class="text-center bg-primary p-2">Address for Shopping</h4>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">Zip Code</label> <input
										type="number" name="zip" class="form-control" id="inputPassword4"required>
								</div>
							</div>
